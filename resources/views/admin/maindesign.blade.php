...
<html>
  ...
  <body>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            {{-- <form action="" id="searchForm">
              <div class="form-group">
                <input type="search" name="search" placeholder="What Are You Searching For.." id="">
              </div>
            </form> --}}
        ...
        {{-- <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Category </a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('admin.addcatrgory')}}">Add Category</a></li>
                    <li><a href="{{route('admin.viewcatrgory')}}">View Category</a></li>
                  </ul>
                </li>  
    ...
    <!-- EXAMPLE -->
    <li>
        <a href="#exampleDropdown" aria-expanded="false" data-toggle="collapse"> 
          ...
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
              <!-- Please do not remove the backlink to us unless you support us at https://bootstrapious.com/donate. It is part of the license conditions. Thank you for understanding :)-->
               <p class="no-margin-bottom">&copy; 2026 Giftos. Design And Developed By Aditya Verma </p>
            </div>
          </div>
        </footer>
      </div>
