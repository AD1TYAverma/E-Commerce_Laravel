...
.my-btn {
    background-color: rgb(219, 70, 102);
    border-color: rgb(219, 70, 102);
...
.my-btn:hover{
    ...
    border-color: rgb(219, 70, 102);
    color: rgb(219, 70, 102) !important;
}
.my-btnn{
  background-color: rgb(40, 166, 69);
  border-color: rgb(40, 166, 69);
  color: white !important;
}
.my-btnn:hover{
  background-color: white;
  border-color: rgb(40, 166, 69);
  color: rgb(40, 166, 69) !important;
}
</style>
            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-sm-5">
                    <div class="img-box">
                      <img style="width:500px" src="{{ asset('front/images/image3.jpeg') }}" alt="" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <footer class=" footer_section">
      <div class="container">
        <p>
          ...
          <a href="https://html.design/">Aditya Verma</a>
        </p>
      </div>
    </footer>
    <!-- footer section -->
